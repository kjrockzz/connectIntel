    ...
    <section className={`testimonial-block style-six overflow-hidden lg:py-20 sm:py-14 py-10 ${classname}`}>
      <div className="container">
        <div className="heading">
          <h3 className="heading3 text-center text-white">Testimonials</h3>
          <p className="text-center mt-2 text-white">Discover exceptional experiences through testimonials from our satisfied customers.</p>
        </div>
